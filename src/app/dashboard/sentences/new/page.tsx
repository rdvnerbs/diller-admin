...
export default function NewSentencePage() {
  ...
  const handleCreateSentence = async () => {
    try {
      ...
      setError(error.message || "Failed to create sentence");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6 flex items-center">
        ...
        <h1 className="text-2xl font-bold">Add New Sentence</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Sentence Information</CardTitle>
          <CardDescription>Add a new example sentence</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-end space-x-4">
          ...
          <Button onClick={handleCreateSentence} disabled={saving}>
