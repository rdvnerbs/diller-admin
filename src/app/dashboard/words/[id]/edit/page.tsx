  ...
  useEffect(() => {
    const fetchWord = async () => {
      try {
        ...
        setFormData({
          kelime_en: data.kelime_en || "",
          kelime_tr: data.kelime_tr || "",
          kelime_en_aciklama: data.kelime_en_aciklama || "",
          kelime_tr_aciklama: data.kelime_tr_aciklama || "",
          resim_url: data.resim_url || "",
          ses_url: data.ses_url || "",
          seviye: data.seviye || "beginner",
          kelime_turu: data.kelime_turu || "noun",
        });
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update vocabulary word details</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-end space-x-4">
          ...
          <Button onClick={handleUpdateWord} disabled={saving}>
